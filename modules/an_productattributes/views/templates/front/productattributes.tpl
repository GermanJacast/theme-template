...
{/if}
	...
	<div class="an_productattributes-qty-add clearfix">
		...
		<div class="an_productattributes-add">
		  <button class="btn an_productattributes-add-to-cart-btn js-an_productattributes-add-to-cart" data-button-action="add-to-cart" type="submit" {if $availableForOrder !='1'} disabled="disabled"{/if} data-status="{$availableForOrder}">
			<i class="material-icons">shopping_bag</i>
			{l s='Añadir a la Bolsa' d='Shop.Theme.Actions'}
		  </button>
		</div>
	</div>
	{/if}
