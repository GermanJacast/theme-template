...
<div id="search_widget" class="search-widget" data-search-controller-url="{$search_controller_url}">
	<form method="get" action="{$search_controller_url}" class="align-middle">
		...
		<button type="submit" >
		   ...
		   <img class="searching" style="display:none" src="{$urls.css_url}preloader.gif" title="{l s='Searching' d='Shop.Theme.Catalog'}">
	   {/if}
